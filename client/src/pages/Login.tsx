...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden p-6">
      ...
      <div className="absolute top-[-20%] left-[-20%] w-[60vw] h-[60vw] rounded-full bg-primary/10 blur-[130px] pointer-events-none animate-pulse-slow"></div>
      <div className="absolute bottom-[-20%] right-[-20%] w-[60vw] h-[60vw] rounded-full bg-accent/5 blur-[130px] pointer-events-none animate-pulse-slow"></div>
      ...
      >
        ...
        {/* Premium Dark Glass Login Card */}
        <div className="glass border border-white/10 rounded-[32px] p-8 shadow-2xl shadow-primary/5 hover:shadow-primary/10 transition-all duration-300 relative">
